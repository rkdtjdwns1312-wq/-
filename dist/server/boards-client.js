export function client(EDITOR){
  ...
  function home(){app.innerHTML='<section class="home-intro"><div><h1>콕하나로 우리끼리</h1><p>오늘의 소식과 대진을 한곳에서.</p></div><img src="/mascot-play.png" alt="배드민턴을 치는 콕끼리" width="175" height="175"></section><nav class="menus" aria-label="게시판"><a class="menu" href="#notice"><span class="menu-num">01</span><span class="menu-title">공지사항</span><small>함께 알아둘 모임 소식</small><span class="menu-arrow" aria-hidden="true">↗</span></a><a class="menu featured" href="#schedule"><span class="menu-num">02</span><span class="menu-title">대진표</span><small>날짜별 대진과 지난 게임</small><span class="menu-arrow" aria-hidden="true">↗</span></a><a class="menu" href="#seed"><span class="menu-num">03</span><span class="menu-title">시드현황</span><small>회원 · 게스트 시드 확인</small><span class="menu-arrow" aria-hidden="true">↗</span></a></nav>'+(EDITOR?'<div class="home-note"><span>새로운 게임을 준비하시나요?</span><button class="primary" id="homeNew">+ 대진 만들기</button></div>':'');if(EDITOR)$('homeNew').onclick=()=>openPicker(null);}
